...
try:
    shutil.copy(os.path.join(ROOT_DIR, 'test', 'Readme.md'), os.path.join(THIS_DIR, "_root", "test_Readme.md"))
...
project = 'proc_profiler'
author = 'GPMF authors'
copyright_string = f'2021, {author}'

with open(os.path.join(ROOT_DIR, 'VERSION'), 'rt', encoding='utf-8') as reader:
    release = reader.read()
